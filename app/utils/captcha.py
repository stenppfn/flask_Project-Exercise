...
class Captcha:
    ...
    def create_captcha(self):
        ...
        # print(parent_path)
        font_file = parent_path +"\static/fonts"+ "/%d.ttf" % font_name
        # temp_font_file = os.path.join(os.path.join(__file__),os.pardir)
        # print(temp_font_file)
        # font_file = temp_font_file + "static/fonts"+ "/%d.ttf" % font_name
        # print(font_file)
